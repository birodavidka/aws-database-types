...
const navItems: NavItem[] = [
  {
    ...
    dropdownItems: [
      ...
      },
      {
        name: "Amazon Aurora",
        href: "/amazonaurora",
        description: "Amazon's MySQL and PostgreSQL-compatible database",
      },
    ],
  },
  {
    ...
    dropdownItems: [
      ...
      },
      {
        ...
        href: "/amazondocumentdb",
        description: "Managed MongoDB-compatible database service",
      },
      {
        name: "Amazon ElastiCache",
        href: "/amazonelasticache",
        description: "In-memory data store and cache service",
      },
      {
        name: "Amazon Neptune",
        href: "/amazonneptune",
        description: "Graph database service for highly connected data",
      },
    ],
  },
